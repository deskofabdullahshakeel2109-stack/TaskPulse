...
namespace TaskPulse.Api.Repositories.Dashboard;
...
public class DashboardRepository : IDashboardRepository
{
    ...
    public async Task<Dictionary<string, int>> GetTasksByStatusAsync(
        Guid projectId)
    {
    ...
    public async Task<Dictionary<string, int>> GetTasksByPriorityAsync(
        Guid projectId)
    {
        return await _context.TaskItems
            .AsNoTracking()
